...
public final class NewfeedPresenterImpl extends BasePresenterImpl<NewfeedView> implements NewfeedPresenter {
    /**
     * The interactor
     */
    @NonNull
    private final NewfeedInteractor mInteractor;

    // The view is available using the mView variable

    @Inject
    public NewfeedPresenterImpl(@NonNull NewfeedInteractor interactor) {
