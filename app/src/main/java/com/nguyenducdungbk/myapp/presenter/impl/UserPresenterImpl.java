...
public final class UserPresenterImpl extends BasePresenterImpl<UserView> implements UserPresenter {
    /**
     * The interactor
     */
    @NonNull
    ...
    @Inject
    public UserPresenterImpl(@NonNull UserInteractor interactor) {
